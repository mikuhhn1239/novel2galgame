#!/usr/bin/env python3
"""v4.1 Scene Boundary — 8×A800 DDP"""
...
DATA = '/workspace/project-nas-1000073/linyupeng/data/datasets/training/v4.1'
OUT  = '/workspace/project-nas-1000073/linyupeng/data/checkpoints/stage2-v4.1'
...
if local_rank == 0:
    print(f"\n{'='*50}\n  v4.1 {TASK} (DeepSeek 2000 + 8×A800 DDP)\n{'='*50}")
    print(f'  train={len(td)} val={len(vd)}')

tok = AutoTokenizer.from_pretrained(BASE, trust_remote_code=True)
if tok.pad_token is None: tok.pad_token = tok.eos_token

# DDP 模式：不加 device_map，让 Trainer 自动分配
...
args = TrainingArguments(
    ...
    gradient_accumulation_steps=2,   # 8×1×2 = 16 effective batch
    num_train_epochs=4,
    learning_rate=1e-4,
