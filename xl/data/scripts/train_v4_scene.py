#!/usr/bin/env python3
"""v4 Scene Boundary — DeepSeek 重标注 + v2 短 prompt"""
...
DATA = '/workspace/project-nas-1000073/linyupeng/data/datasets/training/v4'
OUT  = '/workspace/project-nas-1000073/linyupeng/data/checkpoints/stage2-v4'

TASK = 'scene-boundary-detection'
...
print(f"\n{'='*50}\n  v4 {TASK} (DeepSeek re-annotated + v2-style prompt)\n{'='*50}")
