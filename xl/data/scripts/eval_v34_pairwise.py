...
LORA = '/workspace/project-nas-1000073/linyupeng/data/checkpoints/stage2-v3.4/scene-boundary-pairwise/final'
TEST_PASSAGES = '/workspace/project-nas-1000073/linyupeng/data/datasets/training/v3.3/scene-boundary-binary/test.jsonl'
TEST_PAIRS    = '/workspace/project-nas-1000073/linyupeng/data/datasets/training/v3.4/scene-boundary-pairwise/test.jsonl'
