#!/usr/bin/env python3
"""v3.3 Scene Boundary Binary — 单 Agent 训练"""
...
DATA = '/workspace/project-nas-1000073/linyupeng/data/datasets/training/v3.3'
OUT  = '/workspace/project-nas-1000073/linyupeng/data/checkpoints/stage2-v3.3'

TASK = 'scene-boundary-binary'
