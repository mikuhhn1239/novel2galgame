#!/usr/bin/env python3
"""v3.4 Scene Boundary Pairwise — 滑动窗口二元分类训练"""
...
DATA = '/workspace/project-nas-1000073/linyupeng/data/datasets/training/v3.4'
OUT  = '/workspace/project-nas-1000073/linyupeng/data/checkpoints/stage2-v3.4'

TASK = 'scene-boundary-pairwise'
...
# Pairwise inputs are shorter, 2048 is enough
...
args = TrainingArguments(
    ...
    num_train_epochs=3,  # more data → fewer epochs needed
    learning_rate=1e-4,
