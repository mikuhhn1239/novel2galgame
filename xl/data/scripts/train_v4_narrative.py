#!/usr/bin/env python3
"""Narrative Type Classification — 8×A800 DDP"""
...
DATA = '/workspace/project-nas-1000073/linyupeng/data/datasets/training/v3.2-narrative-type-classification'
OUT  = '/workspace/project-nas-1000073/linyupeng/data/checkpoints/stage2-v4-narrative'
...
if local_rank == 0:
    print(f"\n{'='*50}\n  Narrative Type Classification (8 GPU)\n{'='*50}")
...
# Narrative needs 4096 — long JSON outputs
...
args = TrainingArguments(
    ...
    gradient_accumulation_steps=2,   # 8×1×2 = 16
    num_train_epochs=5,
    learning_rate=1e-4,
