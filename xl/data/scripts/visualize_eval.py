...
MODELS = {
    "narrative-type": '/workspace/project-nas-1000073/已移除-用户名/data/checkpoints/stage2-v3.2/narrative-type-classification/final',
    "scene-boundary": '/workspace/project-nas-1000073/已移除-用户名/data/checkpoints/stage2-v3.1/scene-boundary-detection/final',
    "attribution-best": '/workspace/project-nas-1000073/已移除-用户名/data/checkpoints/stage2-v3.2/attribution-best-candidate/final',
}
...
# ─── 保存原始数据 ───
with open('/workspace/project-nas-1000073/已移除-用户名/data/viz_data.json', 'w') as f:
...
plt.tight_layout()
plt.savefig('/workspace/project-nas-1000073/已移除-用户名/data/eval_visualization.png', dpi=150, bbox_inches='tight')
