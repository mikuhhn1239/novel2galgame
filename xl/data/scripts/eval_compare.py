...
# ─── 路径配置 ───
TEST_DATA = {
    "narrative-type-classification": "/workspace/project-nas-1000073/linyupeng/data/datasets/training/v3.2/narrative-type-classification/test.jsonl",
    "scene-boundary-detection": "/workspace/project-nas-1000073/linyupeng/data/datasets/training/v3.2/scene-boundary-detection/test.jsonl",
    "attribution-best-candidate": "/workspace/project-nas-1000073/linyupeng/data/datasets/training/v3.2/attribution-best-candidate/test.jsonl",
    # v3.3 binary format — same test content, different output format
    "scene-boundary-binary": "/workspace/project-nas-1000073/linyupeng/data/datasets/training/v3.3/scene-boundary-binary/test.jsonl",
}

MODELS = {
    "+Stage2 v3.2": {
        "base": "/workspace/project-nas-1000073/linyupeng/data/checkpoints/stage1-base-sft/final",
        "lora_base": "/workspace/project-nas-1000073/linyupeng/data/checkpoints/stage2-v3.2",
    },
    "+Stage2 v3.3 (Scene Binary)": {
        "base": "/workspace/project-nas-1000073/linyupeng/data/checkpoints/stage1-base-sft/final",
        "lora_base": "/workspace/project-nas-1000073/linyupeng/data/checkpoints/stage2-v3.3",
    },
}
