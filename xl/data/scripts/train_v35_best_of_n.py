...
# ─── 配置 ───
BASE_MODEL  = '/workspace/project-nas-1000073/已移除-用户名/data/checkpoints/stage1-base-sft/final'
LORA_INIT   = '/workspace/project-nas-1000073/已移除-用户名/data/checkpoints/stage2-v3.2/scene-boundary-detection/final'  # v3.2 格式一致
TRAIN_DATA  = '/workspace/project-nas-1000073/已移除-用户名/data/datasets/training/v3.2/scene-boundary-detection/train.jsonl'
TEST_DATA   = '/workspace/project-nas-1000073/已移除-用户名/data/datasets/training/v3.2/scene-boundary-detection/test.jsonl'
OUT_DIR     = '/workspace/project-nas-1000073/已移除-用户名/data/checkpoints/stage2-v3.5'
