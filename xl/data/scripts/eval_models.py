...
CHECKPOINT_DIR = Path("/workspace/project-nas-1000073/linyupeng/data/checkpoints")
TEST_DIR = Path("/workspace/project-nas-1000073/linyupeng/data/datasets/training_opt")
