...
SRC = '/workspace/project-nas-1000073/已移除-用户名/data/datasets/training/v3.3/scene-boundary-binary'
OUT = '/workspace/project-nas-1000073/已移除-用户名/data/datasets/training/v3.4/scene-boundary-pairwise'
