...
SRC = [
    # (路径, 标签)
    ('/workspace/project-nas-1000073/linyupeng/data/datasets/training/scene-boundary-v2', 'v2'),
    ('/workspace/project-nas-1000073/linyupeng/data/datasets/training/v3.2/scene-boundary-detection', 'v3.2'),
]
OUT = '/workspace/project-nas-1000073/linyupeng/data/datasets/training/v3.3/scene-boundary-binary'
